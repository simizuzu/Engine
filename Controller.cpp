...
bool Controller::TriggerStick(ControllerStick stickInput, const float& deadZoneRange = 0.3f, const Mathematics::Vector2& deadZoneInitial = { 1.0f,1.0f })
{
...
bool Controller::InputStick(ControllerStick stickInput, const float& deadZoneRange = 0.3f, const Mathematics::Vector2& deadZoneInitial = { 1.0f,1.0f })
{
    Mathematics::Vector2 vec;
    bool isLeftStick = stickInput <= L_RIGHT;
...
bool Controller::ReleaseTriggerStick(ControllerStick stickInput, const float& deadZoneRange = 0.3f, const Mathematics::Vector2& deadZoneInitial = { 1.0f,1.0f })
{
    Mathematics::Vector2 oldVec;
    Mathematics::Vector2 vec;
    bool isLeftStick = stickInput <= L_RIGHT;
...
Mathematics::Vector2 Controller::GetLeftStickVec(const Mathematics::Vector2& deadZoneRange = { 1.0f,1.0f })
{
...
Mathematics::Vector2 Controller::GetRightStickVec(const Mathematics::Vector2& deadZoneRange = { 1.0f,1.0f })
{
